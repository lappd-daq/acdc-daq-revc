...
#define CC_BUFFERSIZE 10000 //will only be 32 if all goes as expected from firmware
#define ACDC_BUFFERSIZE 10000 //will only be 8001 if all goes as expected from firmware
...
public:
	...
	void setLed(bool En); //if true, will turn LEDs on. 
