...
#define CC_BUFFERSIZE 10000 //will only be 32, but if more, it will crash your system. Sometimes the ACDC buffer comes instead
...
public:
	...
	int readNewAcdcData(); //similar to readAcdcBuffer but without leading or trailing usb commands
